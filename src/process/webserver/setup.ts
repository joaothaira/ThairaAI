...
export function setupBasicMiddleware(app: Express): void {
  ...
  app.use(
    csrf(
      ...
      ['/login', '/api/auth/qr-login', '/api/upload', '/channels/wecom/webhook', '/channels/whatsapp/webhook'], // Excluded: login form, QR login, file upload (API token), WeCom callback, WhatsApp callback
