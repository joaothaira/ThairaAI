...
export function createMainMenuCard(): DingTalkCard {
  return {
    title: 'ThairaAI Assistant',
    text: '### ThairaAI Assistant\n\nWelcome! Choose an action below:',
    btnOrientation: '1',
    btns: [
...
export function createPairingCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      '### Pairing Required',
      '',
      'Please pair your account with ThairaAI:',
      '',
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      '1. Open ThairaAI settings',
...
export function createPairingStatusCard(pairingCode: string): DingTalkCard {
  return {
    ...
    text: [
      ...
      `**Pairing Code:** \`${pairingCode}\``,
      '',
      'Please approve in ThairaAI settings:',
      '1. Open ThairaAI app',
...
export function createHelpCard(): DingTalkCard {
  return {
    title: 'ThairaAI Assistant Help',
    text: [
      '### ThairaAI Assistant Help',
      '',
      'A remote assistant to interact with ThairaAI via DingTalk.',
      '',
      '**Common Actions:**',
...
export function createPairingGuideCard(): DingTalkCard {
  return {
    ...
    text: [
      ...
      '3. Approve pairing in ThairaAI settings',
...
export function createSettingsCard(): DingTalkCard {
  return {
    ...
    text: [
      '### Settings',
      '',
      'Channel settings need to be configured in the ThairaAI app.',
      '',
      'Open ThairaAI > WebUI > Channels',
    ].join('\n'),
