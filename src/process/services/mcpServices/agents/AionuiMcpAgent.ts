 ...
 * - AionuiMcpAgent: 管理 ThairaAI 本地 @office-ai/aioncli-core 的运行时 MCP 配置
 */
export class AionuiMcpAgent extends AbstractMcpAgent {
  ...
  /**
   * 从 ThairaAI 配置中移除 MCP 服务器
   *
   * 注意：ThairaAI 的 MCP 配置由前端（renderer 层）统一管理
   * 这里不做任何操作，因为：
