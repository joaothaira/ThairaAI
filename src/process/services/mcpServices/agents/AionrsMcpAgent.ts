 ...
 * Maps to ThairaAI transport types (snake_case)
 */
...
/**
 * Map aionrs transport type (kebab-case) to ThairaAI transport type
 */
...
/**
 * Map ThairaAI transport type to aionrs transport type (kebab-case)
 */
...
/**
 * Convert an aionrs server config entry to an ThairaAI IMcpServer
 */
...
/**
 * Convert an ThairaAI IMcpServer to an aionrs server config entry
 */
...
/**
 * Thaira CLI (aionrs) MCP agent implementation
 *
...
export class AionrsMcpAgent extends AbstractMcpAgent {
  ...
  getSupportedTransports(): string[] {
    // aionrs supports stdio, sse, streamable-http (mapped to streamable_http in ThairaAI)
