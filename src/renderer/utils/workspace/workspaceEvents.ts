export const WORKSPACE_TOGGLE_EVENT = 'thairaai-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'thairaai-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'thairaai-workspace-has-files';
