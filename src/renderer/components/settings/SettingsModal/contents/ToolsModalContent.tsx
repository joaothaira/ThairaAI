...
const SPEECH_TO_TEXT_CONFIG_CHANGED_EVENT = 'thairaai:speech-to-text-config-changed';
                    ...
                    <Tooltip
                      content={
                        <div>
                          ...
                          <a
                            href='https://github.com/iOfficeAI/ThairaAI/wiki/ThairaAI-Image-Generation-Tool-Model-Configuration-Guide'
                            target='_blank'
