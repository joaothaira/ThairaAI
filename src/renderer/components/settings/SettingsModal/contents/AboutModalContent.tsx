...
const AboutModalContent: React.FC = () => {
  ...
  const checkUpdate = () => {
    ...
    window.dispatchEvent(new CustomEvent('thairaai-open-update-modal', { detail: { source: 'about' } }));
  };

  const linkItems: LinkItem[] = [
    {
      title: t('settings.helpDocumentation'),
      url: 'https://github.com/iOfficeAI/ThairaAI/wiki',
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.updateLog'),
      url: 'https://github.com/iOfficeAI/ThairaAI/releases',
      icon: <Right theme='outline' size='16' />,
    },
    {
      title: t('settings.feedback'),
      url: 'https://github.com/iOfficeAI/ThairaAI/issues',
      icon: <Right theme='outline' size='16' />,
    },
    {
          ...
          <div className='flex flex-col items-center pb-24px'>
            ...
            <div className='flex items-center justify-center gap-8px mb-16px'>
              ...
              <div
                ...
                onClick={() =>
                  openLink('https://github.com/iOfficeAI/ThairaAI').catch((error) =>
