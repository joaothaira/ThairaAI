...
**サポートされている Agent：** 内蔵 Agent（ゼロ設定） • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Thaira CLI（aionrs、AionUi に同梱の Rust バックエンドサービス） • Snow CLI • Kiro • Hermes Agent • Cursor Agent など
...
- **Leader によるオーケストレーション** — Leader が割り当て、追跡、集約；対応バックエンドは Claude Code、Codex、Hermes Agent、Gemini、Snow CLI、Thaira CLI
...
- **対応バックエンド** — Claude Code、Codex、Gemini、Snow CLI、Thaira CLI（aionrs）；`mcpCapabilities.stdio` を持つ他の ACP バックエンドも自動対応
