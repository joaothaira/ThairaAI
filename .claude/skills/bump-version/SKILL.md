---
name: bump-version
description: Use when bumping the ThairaAI version: update package.json, run checks, branch, commit, push, create PR, wait for merge, tag release.
---

# Bump Version

Automate the ThairaAI version bump workflow: update version → quality checks → branch → commit → push → PR → tag.
